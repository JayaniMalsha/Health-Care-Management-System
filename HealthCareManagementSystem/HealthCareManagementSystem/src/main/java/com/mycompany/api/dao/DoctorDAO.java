...
public class DoctorDAO {
    ...
    // Add some mock data
    static {
        doctors.add(new Doctor(1, "Dr. Smith", "smith@example.com", "123 Main St", "Cardiologist"));
        doctors.add(new Doctor(2, "Dr. Johnson", "johnson@example.com", "456 Elm St", "Pediatrician"));
    }
